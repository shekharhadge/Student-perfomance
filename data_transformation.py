...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Applying the preprocessing object on both train and test dataframe")
...
if __name__=="__main__":
    ...
    data_transformation=data_transformation_config.get_data_transformer_object()
